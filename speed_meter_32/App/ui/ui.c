...
{
  static char *battery_levels[] = {LV_SYMBOL_BATTERY_EMPTY, LV_SYMBOL_BATTERY_1, LV_SYMBOL_BATTERY_2, LV_SYMBOL_BATTERY_3, LV_SYMBOL_BATTERY_FULL};
  if(is_charging)
  {
    // 正在充电
    ...
    lv_subject_set_pointer(&speed_meter_sub->battery_level, battery_levels[vol_level / 20]);
