...
void lv_port_disp_init(void)
{
    ...
    // 新加的
    static uint8_t buf1[MY_DISP_HOR_RES * MY_DISP_VER_RES / 10 * 2] = {0};
    static uint8_t buf2[MY_DISP_HOR_RES * MY_DISP_VER_RES / 10 * 2] = {0};
    lv_display_set_buffers(lcd_disp, buf1, buf2, MY_DISP_HOR_RES * MY_DISP_VER_RES / 10 * 2, LV_DISPLAY_RENDER_MODE_PARTIAL);
}
