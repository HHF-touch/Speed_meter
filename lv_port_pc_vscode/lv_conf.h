 ...
 *  @endcode
 */
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(noto_sans_sc_14)

/** Always set a default font */
#define LV_FONT_DEFAULT &noto_sans_sc_14
...
#if LV_USE_FS_WIN32
    #define LV_FS_WIN32_LETTER 'D'     /**< Set an upper-case driver-identifier letter for this driver (e.g. 'A'). */
    #define LV_FS_WIN32_PATH "D:/stm32_cyclometer/bj_map/bj_map"         /**< Set the working directory. File/directory paths will be appended to it. */
